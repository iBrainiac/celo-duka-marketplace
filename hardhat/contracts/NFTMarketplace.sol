...
function createListing(
        ...
        // Cannot create a listing to sell NFT for less than 0 ETH
        require(price > 0, "MRKT: Price must be > 0");

        // If listing already existed, listing.price cannot be  != 0
        require(
...
// Requires that the specified NFT is not already listed for sale thus a new listing
